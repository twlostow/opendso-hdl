...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dsi_backlight_en_o [ create_bd_port -dir O -from 0 -to 0 dsi_backlight_en_o ]
  ...
  set dsi_hs_n_o [ create_bd_port -dir O -from 3 -to 0 dsi_hs_n_o ]
  set dsi_hs_p_o [ create_bd_port -dir O -from 3 -to 0 dsi_hs_p_o ]
  set dsi_lp_n_o [ create_bd_port -dir O -from 3 -to 0 dsi_lp_n_o ]
  set dsi_lp_p_o [ create_bd_port -dir O -from 3 -to 0 dsi_lp_p_o ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#ENET Reset#GPIO#GPIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#I2C 0#I2C 0#Enet 0#Enet 0} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins dsi_core_zynq_wrapper_0/s_axil] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net dsi_core_zynq_wrapper_0_dsi_gpio_o [get_bd_pins dsi_core_zynq_wrapper_0/dsi_gpio_o] [get_bd_pins xlslice_0/Din]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dsi_core_zynq_wrapper_0/s_axil/reg0] SEG_dsi_core_zynq_wrapper_0_reg0
